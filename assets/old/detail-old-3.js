...
const Image_list = (props) => {
    ...
    return (
        <View>
            ...
            {
                props.data.detail_data.ex_media.map(({item}, i)=> <Text key={i}>sdfsfsdfsfd</Text>)
            }

            {/* <FlatList
                data={(props.data && props.data.detail_data != undefined) ? props.data.detail_data.ex_media : []}
