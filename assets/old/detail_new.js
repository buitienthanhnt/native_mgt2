...
import { View, Text, Image, Button, Dimensions, FlatList, TouchableOpacity, StyleSheet, TextInput, Platform } from "react-native";
...
import { ScrollView } from 'react-native-virtualized-view'; //  npm install react-native-virtualized-view --save(dùng cho flatlist trong scrollview lưu ý là cần có: listKey)
